...
function scene:create( event )
  ...
  local bg = display.newImage(sceneGroup, 'assets/bg03.jpg', _CX, _CY)
  btfront = display.newImage(sceneGroup, 'assets/button.png', _W * 17/20, _H * 9/10 )
  btfront:scale(0.5,0.5);

  function btfront:touch( event )
...
function scene:show( event )
  ...
  btfront:addEventListener( "touch", btfront )
...
function scene:hide( event )
  ...
  if ( phase == "will" ) then
    ...
    btfront:removeEventListener( "touch", btfront )
