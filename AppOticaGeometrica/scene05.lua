...
-- -----------------------------------------------------------------------------------
 ...
 local function next() 
    composer.gotoScene('scene06', { effect = "fade" , time = 500 } )
 end
 
 local function prev() 
    composer.gotoScene('scene04', { effect = "fade" , time = 500 } )
 end
...
function scene:create( event )
    ...
    local subject = display.newText( sceneGroup, "Tela 05", _CX, _H *2/20, native.systemFont, 24 )
